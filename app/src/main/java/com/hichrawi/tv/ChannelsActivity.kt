...
class ChannelsActivity : AppCompatActivity() {
    ...
    private fun addChannel(ch: Api.Channel) {
        ...
        // الضغط على الكارت كامل يفتح المشغل
            ...
            lifecycleScope.launch {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        // لا نوقف التطبيق بسبب خطأ مؤقت في الشبكة
                    }
                }
            }
    }
