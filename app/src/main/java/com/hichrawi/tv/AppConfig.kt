...
object AppConfig {
    ...
    private fun parseSettings(obj: JSONObject, previous: AppSettings): AppSettings {
        ...
        return previous.copy(
            ...
            homeVodTitle = s.optString("home_vod_title").takeIf { it.isNotBlank() } ?: previous.homeVodTitle,
            homeSeriesTitle = s.optString("home_series_title").takeIf { it.isNotBlank() } ?: previous.homeSeriesTitle,
