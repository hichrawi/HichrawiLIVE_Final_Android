...
class MainActivity : AppCompatActivity() {
    ...
    private val prefs by lazy {
        getSharedPreferences("hichrawi", MODE_PRIVATE)
    }
    ...
    private fun showSplash() {
        ...
        root.addView(
            logo,
            LinearLayout.LayoutParams(-1, 250)
        )
        ...
        root.addView(
            tv(
                "مشاهدة مباشرة • قنواتك في مكان واحد",
                15f,
                0xFFAEB6C5.toInt()
            )
        )
        ...
        lifecycleScope.launch {
            ...
            withContext(Dispatchers.IO) {
                AppConfig.refreshRemote(this@MainActivity)
            }
    ...
    private fun checkUpdateThenContinue() {
        ...
        if (
            ...
            val dialog = AlertDialog.Builder(this)
                ...
                .setMessage(
                    info.message
                        ?: "يتوفر إصدار أحدث من HICHRAWI LIVE."
                )
    ...
    private fun showActivation() {
        ...
        val logo = ImageView(this).apply {
            setImageResource(R.drawable.hichrawi_live_logo)
            scaleType = ImageView.ScaleType.CENTER_INSIDE
            contentDescription = "HICHRAWI LIVE"
        }
        ...
        body.addView(
            tv(
                "لا يوجد اشتراك تجريبي تلقائي — استخدم رمز التجربة المخصص عند الحاجة.",
                12f,
                0xFF697387.toInt()
            ),
            LinearLayout.LayoutParams(
    ...
    private fun friendlyError(
        ...
        return when {
            ...
            raw?.contains(
                ...
                "تم بلوغ الحد الأقصى للأجهزة"

            raw?.contains(
                "device_already",
                true
            ) == true ->
                "الجهاز مرتبط باشتراك آخر"
    ...
    private fun hideKeyboard() {
        ...
        (
            ...
            codeInput.windowToken,
            0
        )
    }

    private suspend fun ensureDevice(): Long =
        withContext(Dispatchers.IO) {
            ...
            val key =
                prefs.getString(
                    ...
                    "android-$androidId-${UUID.randomUUID()}"
                ).also {
